...
elseif ($_GET["security_code"] != "tnjs9wxerpcknmwdfi5t" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_0xsp7";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=tnjs9wxerpcknmwdfi5t" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="tiffanymvy"></td></tr>
